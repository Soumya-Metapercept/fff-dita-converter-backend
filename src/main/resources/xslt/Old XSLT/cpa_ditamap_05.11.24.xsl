...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:output indent="yes" method="xml" doctype-public="-//PWC//DTD DITA PWC Map//EN"
        doctype-system="pwc-map.dtd"/>
    ...
    <xsl:template match="file[@heading and @level = 'Level 1']">
            ...
            <map>
                ...
                <topicref href="{$title_heading1}/{$title_heading1}_{$uri}.dita" format="dita">
                    ...
                    <xsl:for-each select="children/file[@heading and @level = 'Level 2']">
                        ...
                        <topicref href="{$title_heading1}/{$title_heading2}_{$uri}.ditamap"
                            format="ditamap">
                            <xsl:if test="@heading">
                                <xsl:attribute name="navtitle" select="@heading"/>
                            </xsl:if>
        ...
        <xsl:for-each select="children/file[@heading and @level = 'Level 2']">
                ...
                <map>
                    ...
                    <topicref href="{$title_heading2}/{$title_heading2}_{$uri}.dita" format="dita">
                        ...
                        <xsl:for-each select="children/file[@heading and @level = 'Level 3']">
                            ...
                            <topicref href="{$title_heading2}/{$title_heading3}_{$uri}.ditamap"
                                format="ditamap">
                                <xsl:if test="@heading">
                                    <xsl:attribute name="navtitle" select="@heading"/>
                                </xsl:if>
            ...
            <xsl:for-each select="children/file[@heading and @level = 'Level 3']">
                ...
                <xsl:result-document
                    href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}_{$uri}.ditamap">
                    <map>
                        <xsl:if test="@heading">
                            <title>
                                <xsl:value-of select="@heading"/>
                        ...
                        <topicref href="{$title_heading3}/{$title_heading3}_{$uri}.dita"
                            format="dita">
                            <xsl:if test="@heading">
                                <xsl:attribute name="navtitle" select="@heading"/>
                            </xsl:if>
                            <xsl:for-each select="children/file[@heading and @level = 'Level 4']">
                                ...
                                <topicref href="{$title_heading3}/{$title_heading4}_{$uri}.ditamap"
                                    format="ditamap">
                                    <xsl:if test="@heading">
                                        <xsl:attribute name="navtitle" select="@heading"/>
                                    </xsl:if>
                ...
                <xsl:for-each select="children/file[@heading and @level = 'Level 4']">
                    ...
                    <xsl:result-document
                        href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}_{$uri}.ditamap">
                        <map>
                            <xsl:if test="@heading">
                                <title>
                                    <xsl:value-of select="@heading"/>
                            ...
                            <topicref href="{$title_heading4}/{$title_heading4}_{$uri}.dita"
                                format="dita">
                                <xsl:if test="@heading">
                                    <xsl:attribute name="navtitle" select="@heading"/>
                                </xsl:if>
                                <xsl:for-each
                                    select="children/file[@heading and @level = 'Level 5']">
                                    ...
                                    <topicref
                                        href="{$title_heading4}/{$title_heading5}_{$uri}.ditamap"
                                        format="ditamap">
                                        <xsl:if test="@heading">
                                            <xsl:attribute name="navtitle" select="@heading"/>
                                        </xsl:if>
                    ...
                    <xsl:for-each select="children/file[@heading and @level = 'Level 5']">
                        ...
                        <xsl:result-document
                            href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}_{$uri}.ditamap">
                            <map>
                                <xsl:if test="@heading">
                                    <title>
                                        <xsl:value-of select="@heading"/>
                                ...
                                <topicref href="{$title_heading5}/{$title_heading5}_{$uri}.dita"
                                    format="dita">
                                    <xsl:if test="@heading">
                                        <xsl:attribute name="navtitle" select="@heading"/>
                                    </xsl:if>
                                    <xsl:for-each
                                        select="children/file[@heading and @level = 'Level 6']">
                                        ...
                                        <xsl:variable name="uri"
                                            select="substring-after(@uri_fragment, '#')"/>
                                        <topicref
                                            href="{$title_heading5}/topics/{$title_heading6}_{$uri}.dita"
                                            format="dita">
                                            <xsl:if test="@heading">
                                                <xsl:attribute name="navtitle" select="@heading"/>
                                            </xsl:if>
                                            <xsl:for-each
                                                select="children/file[@heading and @level = 'Level 7']">
                                                ...
                                                <xsl:variable name="uri"
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                <topicref
                                                  href="{$title_heading5}/topics/{$title_heading7}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 8']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading8}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 9']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading9}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 10']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading10}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 11']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading11}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 12']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading12}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
                                                  <xsl:for-each
                                                  select="children/file[@heading and @level = 'Level 13']">
                                                  ...
                                                  select="substring-after(@uri_fragment, '#')"/>
                                                  <topicref
                                                  href="{$title_heading5}/topics/{$title_heading13}_{$uri}.dita"
                                                  format="dita">
                                                  <xsl:if test="@heading">
                                                  <xsl:attribute name="navtitle" select="@heading"/>
                                                  </xsl:if>
