    ...
    <xsl:template match="file[@heading and @level]">
        ...
        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading1}_{$uri}.dita">
            ...
            <xsl:for-each select="children/file[@heading and @level]">
                ...
                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading2}_{$uri}.dita">
                    <file>
                    ...
                    <xsl:for-each select="children/file[@heading and @level]">
                        ...
                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading3}_{$uri}.dita">
                            <file>
                            ...
                            <xsl:for-each select="children/file[@heading and @level]">
                                ...
                                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading4}_{$uri}.dita">
                                    <file>
                                    ...
                                    <xsl:for-each select="children/file[@heading and @level]">
                                        ...
                                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/{$title_heading5}_{$uri}.dita">
                                            <file>
                                            ...
                                            <xsl:for-each select="children/file[@heading and @level]">
                                                ...
                                                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading6}_{$uri}.dita">
                                                    <file>
                                                    ...
                                                    <xsl:for-each select="children/file[@heading and @level]">
                                                        ...
                                                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading7}_{$uri}.dita">
                                                            <file>
                                                            ...
                                                            <xsl:for-each select="children/file[@heading and @level]">
                                                                ...
                                                                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading8}_{$uri}.dita">
                                                                    <file>
                                                                    ...
                                                                    <xsl:for-each select="children/file[@heading and @level]">
                                                                        ...
                                                                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading9}_{$uri}.dita">
                                                                            <file>
                                                                            ...
                                                                            <xsl:for-each select="children/file[@heading and @level]">
                                                                                ...
                                                                                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading10}_{$uri}.dita">
                                                                                    <file>
                                                                                    ...
                                                                                    <xsl:for-each select="children/file[@heading and @level]">
                                                                                        ...
                                                                                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading11}_{$uri}.dita">
                                                                                            <file>
                                                                                            ...
                                                                                            <xsl:for-each select="children/file[@heading and @level]">
                                                                                                ...
                                                                                                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading12}_{$uri}.dita">
                                                                                                    <file>
                                                                                                    ...
                                                                                                    <xsl:for-each select="children/file[@heading and @level]">
                                                                                                        ...
                                                                                                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}/topics/{$title_heading13}_{$uri}.dita">
                                                                                                            <file>
