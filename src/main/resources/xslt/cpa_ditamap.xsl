...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:output indent="yes" method="xml" doctype-public="-//PWC//DTD DITA PWC Map//EN" doctype-system="pwc-map.dtd"/>
    ...
    <xsl:template match="infobase">
        <xsl:variable name="root_ditamap" select="'cpa'"/>
        <xsl:result-document href="{$root_ditamap}.ditamap">
            <map>
                <xsl:if test="@author">
                    <title>
                ...
                <topicref href="cpa/{$title_heading1}_{$uri}.ditamap" format="ditamap">
                    <xsl:if test="@heading">
    ...
    <xsl:template match="file[@heading and @level = 'Level 1']">
        ...
        <xsl:result-document href="cpa/{$title_heading1}_{$uri}.ditamap">
            <map>
                <xsl:if test="@heading">
                    <title>
                ...
                <topicref href="{$title_heading1}/{$title_heading1}_{$uri}.dita" format="dita">
                    <xsl:if test="@heading">
                        <xsl:attribute name="navtitle" select="@heading"/>
                    </xsl:if>
                    <xsl:for-each select="children/file[@heading and @level = 'Level 2']">
                        ...
                        <topicref href="{$title_heading1}/{$title_heading2}_{$uri}.ditamap" format="ditamap">
                            <xsl:if test="@heading">
                                <xsl:attribute name="navtitle" select="@heading"/>
                            </xsl:if>
                        </topicref>
        ...
        <xsl:for-each select="children/file[@heading and @level = 'Level 2']">
            ...
            <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}_{$uri}.ditamap">
                <map>
                    <xsl:if test="@heading">
                        <title>
                            <xsl:value-of select="@heading"/>
                    ...
                    <topicref href="{$title_heading2}/{$title_heading2}_{$uri}.dita" format="dita">
                        <xsl:if test="@heading">
                            <xsl:attribute name="navtitle" select="@heading"/>
                        </xsl:if>
                        <xsl:for-each select="children/file[@heading and @level = 'Level 3']">
                            ...
                            <topicref href="{$title_heading2}/{$title_heading3}_{$uri}.ditamap" format="ditamap">
                                <xsl:if test="@heading">
                                    <xsl:attribute name="navtitle" select="@heading"/>
                                </xsl:if>
<!--                                <xsl:attribute name="chunk" select="'to-content'"/>
                                <xsl:attribute name="copy-to" select="replace($Title3, ' ','-')"/>-->
                            </topicref>
            ...
            <xsl:for-each select="children/file[@heading and @level = 'Level 3']">
                ...
                <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}_{$uri}.ditamap">
                    <map>
                        <xsl:if test="@heading">
                            <title>
                                <xsl:value-of select="@heading"/>
                        ...
                        <topicref href="{$title_heading3}/{$title_heading3}_{$uri}.dita" format="dita">
                            <xsl:if test="@heading">
                                <xsl:attribute name="navtitle" select="@heading"/>
                            </xsl:if>
                            <xsl:for-each select="children/file[@heading and @level = 'Level 4']">
                                ...
                                <xsl:variable name="title_heading4" select="replace($Title4, ' ','_')"/>
                                
                                <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                <topicref href="{$title_heading3}/{$title_heading4}_{$uri}.ditamap" format="ditamap">
                                    <xsl:if test="@heading">
                                        <xsl:attribute name="navtitle" select="@heading"/>
                                    </xsl:if>
                                </topicref>
                ...
                <xsl:for-each select="children/file[@heading and @level = 'Level 4']">
                    ...
                    <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}_{$uri}.ditamap">
                        <map>
                            <xsl:if test="@heading">
                                <title>
                                    <xsl:value-of select="@heading"/>
                            ...
                            <topicref href="{$title_heading4}/{$title_heading4}_{$uri}.dita" format="dita">
                                <xsl:if test="@heading">
                                    <xsl:attribute name="navtitle" select="@heading"/>
                                </xsl:if>
                                <xsl:for-each select="children/file[@heading and @level = 'Level 5']">
                                    ...
                                    <xsl:variable name="title_heading5" select="replace($Title5, ' ','_')"/>
                                    
                                    <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                    
                                    <topicref href="{$title_heading4}/{$title_heading5}_{$uri}.ditamap" format="ditamap">
                                        <xsl:if test="@heading">
                                            <xsl:attribute name="navtitle" select="@heading"/>
                                        </xsl:if>
                                    </topicref>
                    ...
                    <xsl:for-each select="children/file[@heading and @level = 'Level 5']">
                        ...
                        <xsl:result-document href="cpa/{$title_heading1}/{$title_heading2}/{$title_heading3}/{$title_heading4}/{$title_heading5}_{$uri}.ditamap">
                            <map>
                                <xsl:if test="@heading">
                                    <title>
                                        <xsl:value-of select="@heading"/>
                                ...
                                <topicref href="{$title_heading5}/{$title_heading5}_{$uri}.dita" format="dita">
                                    <xsl:if test="@heading">
                                        <xsl:attribute name="navtitle" select="@heading"/>
                                    </xsl:if>
                                    <xsl:for-each select="children/file[@heading and @level = 'Level 6']">
                                        ...
                                        <xsl:variable name="title_heading6" select="replace($Title6, ' ','_')"/>
                                        
                                        <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                        <topicref href="{$title_heading5}/topics/{$title_heading6}_{$uri}.dita" format="dita">
                                            <xsl:if test="@heading">
                                                <xsl:attribute name="navtitle" select="@heading"/>
                                            </xsl:if>
                                            <xsl:for-each select="children/file[@heading and @level = 'Level 7']">
                                                ...
                                                <xsl:variable name="title_heading7" select="replace($Title7, ' ','_')"/>
                                                
                                                <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                <topicref href="{$title_heading5}/topics/{$title_heading7}_{$uri}.dita" format="dita">
                                                    <xsl:if test="@heading">
                                                        <xsl:attribute name="navtitle" select="@heading"/>
                                                    </xsl:if>
                                                    <xsl:for-each select="children/file[@heading and @level = 'Level 8']">
                                                        ...
                                                        <xsl:variable name="title_heading8" select="replace($Title8, ' ','_')"/>
                                                        
                                                        <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                        <topicref href="{$title_heading5}/topics/{$title_heading8}_{$uri}.dita" format="dita">
                                                            <xsl:if test="@heading">
                                                                <xsl:attribute name="navtitle" select="@heading"/>
                                                            </xsl:if>
                                                            <xsl:for-each select="children/file[@heading and @level = 'Level 9']">
                                                                ...
                                                                <xsl:variable name="title_heading9" select="replace($Title9, ' ','_')"/>
                                                                
                                                                <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                                <topicref href="{$title_heading5}/topics/{$title_heading9}_{$uri}.dita" format="dita">
                                                                    <xsl:if test="@heading">
                                                                        <xsl:attribute name="navtitle" select="@heading"/>
                                                                    </xsl:if>
                                                                    <xsl:for-each select="children/file[@heading and @level = 'Level 10']">
                                                                        ...
                                                                        <xsl:variable name="title_heading10" select="replace($Title10, ' ','_')"/>
                                                                        
                                                                        <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                                        <topicref href="{$title_heading5}/topics/{$title_heading10}_{$uri}.dita" format="dita">
                                                                            <xsl:if test="@heading">
                                                                                <xsl:attribute name="navtitle" select="@heading"/>
                                                                            </xsl:if>
                                                                            <xsl:for-each select="children/file[@heading and @level = 'Level 11']">
                                                                                ...
                                                                                <xsl:variable name="title_heading11" select="replace($Title11, ' ','_')"/>
                                                                                
                                                                                <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                                                <topicref href="{$title_heading5}/topics/{$title_heading11}_{$uri}.dita" format="dita">
                                                                                    <xsl:if test="@heading">
                                                                                        <xsl:attribute name="navtitle" select="@heading"/>
                                                                                    </xsl:if>
                                                                                    <xsl:for-each select="children/file[@heading and @level = 'Level 12']">
                                                                                        ...
                                                                                        <xsl:variable name="title_heading12" select="replace($Title12, ' ','_')"/>
                                                                                        
                                                                                        <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                                                        <topicref href="{$title_heading5}/topics/{$title_heading12}_{$uri}.dita" format="dita">
                                                                                            <xsl:if test="@heading">
                                                                                                <xsl:attribute name="navtitle" select="@heading"/>
                                                                                            </xsl:if>
                                                                                            <xsl:for-each select="children/file[@heading and @level = 'Level 13']">
                                                                                                ...
                                                                                                <xsl:variable name="title_heading13" select="replace($Title13, ' ','_')"/>
                                                                                                
                                                                                                <xsl:variable name="uri" select="substring-after(@uri_fragment, '#')"/>
                                                                                                <topicref href="{$title_heading5}/topics/{$title_heading13}_{$uri}.dita" format="dita">
                                                                                                    <xsl:if test="@heading">
                                                                                                        <xsl:attribute name="navtitle" select="@heading"/>
                                                                                                    </xsl:if>
                                                                                                </topicref>
